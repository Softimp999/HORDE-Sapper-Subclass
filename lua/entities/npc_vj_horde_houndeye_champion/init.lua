...
function ENT:CustomOnMeleeAttack_BeforeChecks()
	...
	util.VJ_SphereDamage(self, self, self:GetPos() + Vector(0,0,16), 350, math.random(140,300), self.MeleeAttackDamageType, true, true, {DisableVisibilityCheck=true, Force=80})
end
---------------------------------------------------------------------------------------------------------------------------------------------
...
/*-----------------------------------------------
	*** Copyright (c) 2012-2021 by DrVrej, All rights reserved. ***
	...
	without the prior written consent of the author, unless otherwise indicated for stand-alone materials.
--------------------------------------*/---------
VJ.AddNPC("Houndeye Champion","npc_vj_horde_houndeye_champion", "HORDE: Sapper")